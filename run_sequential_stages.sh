...
PY
  ...
  cat > "$CONFIG_DIR/stage3_fullyear_random.py" <<'PY'
...
run_stage \
  "stage3" \
  "examples.config.pv_tracking.stage3_fullyear_random" \
  "$CONFIG_DIR/stage3_fullyear_random.py" \
  "$EVAL_ROOT/pv_stage3_fullyear_random" \
  "2020-01-15,2020-03-20,2020-06-21,2020-08-01,2020-10-15,2020-12-21" \
  "random" \
  "stage3" \
  "2020-01-01" \
  "2020-12-31" \
